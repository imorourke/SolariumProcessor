...
\begin{table}[h!]
	...
	\begin{footnotesize}
		\begin{tabular}{c|cc|l|l}
            ...
            A & 5 & 0 & \texttt{brk} & Debug Breakpoint (capturable by hardware if supported; otherwise, acts as a \texttt{noop}) \\
...
\lstinputlisting[label={listing:example-cbuoy-print-asm},caption={Replacement print function to improve the speed of the resulting output}]{../cbuoy/examples/components/kserialio.cb}
...
\lstinputlisting[caption={Utilities that use a mix of Jib assembly and C/Buoy provide mechanisms to create threads at runtime and swich between threads, either through preemptive interrupts or task yielding.}, label={listing:cbuoy-threading-utils}]{../cbuoy/examples/components/ktsk.cb}
